...
reg   [7:0] t_V_1_reg_180;
wire   [0:0] exitcond2_fu_196_p2;
wire    ap_CS_fsm_state2;
reg    ap_block_state2;
wire   [7:0] i_V_fu_202_p2;
reg   [7:0] i_V_reg_257;
...
assign axi_last_V_fu_220_p2 = ((t_V_1_reg_180 == 8'd224) ? 1'b1 : 1'b0);

assign exitcond2_fu_196_p2 = ((t_V_reg_169 == 8'd225) ? 1'b1 : 1'b0);

assign exitcond_fu_208_p2 = ((t_V_1_reg_180 == 8'd225) ? 1'b1 : 1'b0);

assign i_V_fu_202_p2 = (t_V_reg_169 + 8'd1);

assign j_V_fu_214_p2 = (t_V_1_reg_180 + 8'd1);
