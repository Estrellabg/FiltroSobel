...
// ==============================================================
#ifndef __image_filter_daddrcU__HH__
#define __image_filter_daddrcU__HH__
#include "ACMP_dadd.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(image_filter_daddrcU) {
    ...
    SC_CTOR(image_filter_daddrcU):  ACMP_dadd_U ("ACMP_dadd_U") {
        ACMP_dadd_U.clk(clk);
