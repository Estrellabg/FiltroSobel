...
(* CORE_GENERATION_INFO="image_filter,hls_ip_2018_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z045ffg900-2,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=10.674000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=9,HLS_SYN_DSP=39,HLS_SYN_FF=5181,HLS_SYN_LUT=9246,HLS_VERSION=2018_3}" *)
...
wire   [8:0] Block_proc_U0_img_0_rows_V_out_din;
wire    Block_proc_U0_img_0_rows_V_out_write;
wire   [8:0] Block_proc_U0_img_0_cols_V_out_din;
wire    Block_proc_U0_img_0_cols_V_out_write;
wire   [8:0] Block_proc_U0_img_5_rows_V_out_din;
wire    Block_proc_U0_img_5_rows_V_out_write;
wire   [8:0] Block_proc_U0_img_5_cols_V_out_din;
...
wire   [8:0] AXIvideo2Mat_U0_img_rows_V_out_din;
wire    AXIvideo2Mat_U0_img_rows_V_out_write;
wire   [8:0] AXIvideo2Mat_U0_img_cols_V_out_din;
...
wire   [8:0] AddWeighted_U0_dst_rows_V_out_din;
wire    AddWeighted_U0_dst_rows_V_out_write;
wire   [8:0] AddWeighted_U0_dst_cols_V_out_din;
...
wire   [8:0] img_0_rows_V_c22_dout;
wire    img_0_rows_V_c22_empty_n;
wire    img_0_cols_V_c23_full_n;
wire   [8:0] img_0_cols_V_c23_dout;
...
wire   [8:0] img_5_rows_V_c24_dout;
wire    img_5_rows_V_c24_empty_n;
wire    img_5_cols_V_c25_full_n;
wire   [8:0] img_5_cols_V_c25_dout;
...
fifo_w9_d2_A img_0_rows_V_c22_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w9_d2_A img_0_cols_V_c23_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w9_d2_A img_5_rows_V_c24_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w9_d2_A img_5_cols_V_c25_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
start_for_Sobel_1yd2 start_for_Sobel_1yd2_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
