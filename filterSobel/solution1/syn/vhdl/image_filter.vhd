...
architecture behav of image_filter is 
    ...
    "image_filter,hls_ip_2018_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z045ffg900-2,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=10.674000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=9,HLS_SYN_DSP=39,HLS_SYN_FF=5181,HLS_SYN_LUT=9246,HLS_VERSION=2018_3}";
    ...
    signal Block_proc_U0_img_0_rows_V_out_din : STD_LOGIC_VECTOR (8 downto 0);
    signal Block_proc_U0_img_0_rows_V_out_write : STD_LOGIC;
    signal Block_proc_U0_img_0_cols_V_out_din : STD_LOGIC_VECTOR (8 downto 0);
    signal Block_proc_U0_img_0_cols_V_out_write : STD_LOGIC;
    signal Block_proc_U0_img_5_rows_V_out_din : STD_LOGIC_VECTOR (8 downto 0);
    signal Block_proc_U0_img_5_rows_V_out_write : STD_LOGIC;
    signal Block_proc_U0_img_5_cols_V_out_din : STD_LOGIC_VECTOR (8 downto 0);
    ...
    signal AXIvideo2Mat_U0_img_rows_V_out_din : STD_LOGIC_VECTOR (8 downto 0);
    signal AXIvideo2Mat_U0_img_rows_V_out_write : STD_LOGIC;
    signal AXIvideo2Mat_U0_img_cols_V_out_din : STD_LOGIC_VECTOR (8 downto 0);
    ...
    signal AddWeighted_U0_dst_rows_V_out_din : STD_LOGIC_VECTOR (8 downto 0);
    signal AddWeighted_U0_dst_rows_V_out_write : STD_LOGIC;
    signal AddWeighted_U0_dst_cols_V_out_din : STD_LOGIC_VECTOR (8 downto 0);
    ...
    signal img_0_rows_V_c22_dout : STD_LOGIC_VECTOR (8 downto 0);
    signal img_0_rows_V_c22_empty_n : STD_LOGIC;
    signal img_0_cols_V_c23_full_n : STD_LOGIC;
    signal img_0_cols_V_c23_dout : STD_LOGIC_VECTOR (8 downto 0);
    ...
    signal img_5_rows_V_c24_dout : STD_LOGIC_VECTOR (8 downto 0);
    signal img_5_rows_V_c24_empty_n : STD_LOGIC;
    signal img_5_cols_V_c25_full_n : STD_LOGIC;
    signal img_5_cols_V_c25_dout : STD_LOGIC_VECTOR (8 downto 0);
    ...
    component start_for_Sobel_1yd2 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    ...
    img_0_rows_V_c_U : component fifo_w9_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
    ...
    img_0_cols_V_c_U : component fifo_w9_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    img_5_rows_V_c_U : component fifo_w9_d7_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    img_5_cols_V_c_U : component fifo_w9_d7_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    img_0_rows_V_c22_U : component fifo_w9_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    img_0_cols_V_c23_U : component fifo_w9_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    img_5_rows_V_c24_U : component fifo_w9_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    img_5_cols_V_c25_U : component fifo_w9_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_Sobel_1yd2_U : component start_for_Sobel_1yd2
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
