...
execute()
{
  irun $irun_opts \
       ...
       -top xil_defaultlib.filtro \
       -f run.f \
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../filtro.srcs/sources_1/bd/filtro/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../filtro.srcs/sources_1/bd/filtro/ipshared/70cf/hdl" \
       +incdir+"$ref_dir/../../../../filtro.srcs/sources_1/bd/filtro/ipshared/58e2/hdl" \
       +incdir+"../../../../filtro.srcs/sources_1/bd/filtro/ipshared/ec67/hdl" \
       +incdir+"../../../../filtro.srcs/sources_1/bd/filtro/ipshared/70cf/hdl" \
       +incdir+"../../../../filtro.srcs/sources_1/bd/filtro/ip/filtro_processing_system7_0_0" \
       +incdir+"../../../../filtro.srcs/sources_1/bd/filtro/ipshared/58e2/hdl" \
       +incdir+"C:/Users/aidag/Xilinx/Vivado/2018.3/data/xilinx_vip/include"
}
